     ...
     <div class="container-fluid">
       <div class="row" >
         <div class="col sidebar primary-color">
           ...
           <a href="#">Party List</a>
           <hr>
           <a href="log.php"  class="sidebar-active">Activity</a>
         ...
         <div class="col main-content">
           ...
           <div class="row">
            <div class=" row btn-group">
                ...
                <div class="col-4"></div>
                <div class="col-4">
                 <!-- <form action="#" method="" enctype="multipart/form-data" class="mt-2">
                     <div class="row form-group">
                        <div class="col-10">
                            <input type="text" class="form-control p-1" placeholder="Enter ID or Passport Number">
          ...
          <table id="" class="table table-bordered table-hover table-fixed table-sm mt-4" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              <tr>
                <td>Tiger Nixon</td>
                <td>LEADERSHIP</td>
                <td>Deleted 31179164 - Roy Ombasa from Makueni-Wote Ward MCAs</td>
                <td>15/12/2021 at 6:31pm</td>
              </tr>
              <tr>
                <td>Tiger Nixon</td>
                <td>LEADERSHIP</td>
