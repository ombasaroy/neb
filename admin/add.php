      ...
      <?php
              if(isset($_GET['success'])){
                ...
                if(isset($_SESSION['wrong_values'])){
                  echo "<div class='alert alert-info'>". $_SESSION['wrong_values'] . "</div>";
                }
              }
            ...
            ?>
        <form action="../backend/addaspirant.php" method="post" enctype="multipart/form-data" class="registration-form" id="registration-form">
          <h3>ADD ASPIRANT</h3>
            ...
            <div class="input-sections">
              <div class="row form-group">
                ...
                <div class="col">
                  ...
                  <select name="position" data-live-search="true" id="position" class="form-control"  required>
                    <option value="">------</option>
                ...
                <div class="col">
                  ...
                  <select name="county" id="county" class="form-control county_list"  required>
                    <option value="">------</option>
              ...
              <div class="col">
                  ...
                  <select name="constituency" id="constituency"  class="form-control constituency_list" required class="form-control">
                  <option value="">------</option>
...
<!-- Row 4 starts here -->
            <div class="row form-group mt-4">
              ...
              <div class="col">
                ...
                <input type="date" name="date-of-birth" id="date-of-birth" class="form-control date-of-birth"  required>
              </div>
