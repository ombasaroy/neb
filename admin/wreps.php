  ...
  if (isset($_GET['delete'])) {
    ...
    if ($conn->query($delete_sql) === TRUE) {
      ...
      $_SESSION['deleted'] = "Aspirant details deleted successfully";
        header('location: wreps.php?deleted');
    }else{
      $_SESSION['not_deleted'] = "Aspirant not deleted";
        header('location: wreps.php?not_deleted');
    }

}

  $sql = "SELECT * from aspirants WHERE position = 'wrep'";
        ...
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <h4 class="navbar-brand">
              <span><img src="../images/circlelogo.png" alt="" width="40" class="img-fluid"></span> WIPER DEMOCRATIC MOVEMENT</h4>
          </a>
     ...
     <div class="container-fluid">
       <div class="row" >
         <div class="col sidebar primary-color">
           ...
           <a href="wreps.php" class="sidebar-active">WREPs</a>
         ...
         <div class="col main-content">
           <br>
           <h6>COUNTY WOMEN REPRESENTATIVES ASPIRANTS</h6>
           <?php
            ...
            <?php
              ...
              <tr>
                ...
                <td class="actions">
                  ...
                  <a href="wreps.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger">DELETE</a>
                </td>
              </tr>
              <?php
              endwhile;
